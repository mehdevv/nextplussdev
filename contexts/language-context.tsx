...
const translations = {
  en: {
    ...
    "about.description1":
      "a full-stack web developer, trainer, and founder of pluss.dev — building modern, scalable web applications for clients and startups in Algeria and beyond.",
    "about.description2": "As Vice-President of the Digital Valley Club at ESGEN and a GDG ENSIA member, I lead FinTech initiatives, organize tech events, and deliver",
    "about.skills": "full-stack workshops and freelance projects",
    "about.description3":
      "with React, React Native, Node.js, MongoDB, Supabase, and Tailwind CSS — from scoping to deployment. Winner of multiple national hackathons (INJAZ Headway, Business Road, Innobyte).",
    "about.approach":
      "I also use Figma, n8n, and AI tools for UI/UX design, workflow automation, and rapid prototyping",
    "about.values": "",
    "about.commitment": "— so every product is polished, maintainable, and ready to scale.",
    "about.connect": "Let's Connect",
    "about.learnMore": "Learn More",
    "about.downloadCv": "Download CV",
    "about.gallery.drag": "← drag to browse →",
    "about.headline.role": "Full-stack developer & technical trainer",
    "about.headline.experience": "3+ years building for startups and clients",
    "about.headline.founder": "Founder of pluss.dev — Algeria and beyond",
    "about.headline.training":
      "Full-stack workshops & freelance — React, React Native, Node.js, MongoDB, Supabase",
    "about.headline.community":
      "VP Digital Valley Club · GDG ENSIA — FinTech, tech events & leadership",
    ...
    "contact.description": "Have a project in mind? Tell me about it — I'd love to collaborate.",
    "contact.intro":
    ...
    "contact.ctaPrimary": "Start a project",
    "contact.ctaSecondary": "View service packs",
  ...
  fr: {
    ...
    "about.name": "Mehdi Kernou",
    "about.description1":
      "développeur web full-stack, formateur et fondateur de pluss.dev — je conçois des applications web modernes et évolutives pour des clients et startups en Algérie et à l'international.",
    "about.description2":
      "Vice-Président du Digital Valley Club à l'ESGEN et membre du GDG ENSIA, j'anime des initiatives FinTech, j'organise des événements tech et je dispense des",
    "about.skills": "formations full-stack et des missions freelance",
    "about.description3":
      "avec React, React Native, Node.js, MongoDB, Supabase et Tailwind CSS — de la conception au déploiement. Lauréat de plusieurs hackathons nationaux (INJAZ Headway, Business Road, Innobyte).",
    "about.approach":
      "J'utilise aussi Figma, n8n et l'IA pour le design UI/UX, l'automatisation des workflows et le prototypage rapide",
    "about.values": "",
    "about.commitment": "— pour livrer des produits soignés, maintenables et prêts à évoluer.",
    "about.connect": "Restons Connectés",
    "about.learnMore": "En savoir plus",
    "about.downloadCv": "Télécharger le CV",
    "about.gallery.drag": "← glisser pour parcourir →",
    "about.headline.role": "Développeur full-stack & formateur technique",
    "about.headline.experience": "3+ ans d'expérience avec startups et clients",
    "about.headline.founder": "Fondateur de pluss.dev — Algérie et international",
    "about.headline.training":
      "Formations full-stack & freelance — React, React Native, Node.js, MongoDB, Supabase",
    "about.headline.community":
      "VP Digital Valley Club · GDG ENSIA — FinTech, événements tech & leadership",
    "about.headline.hackathons":
    ...
    "techStack.subtitle":
      "Outils et frameworks que j'utilise pour créer des applications web modernes, du front au back et l'automatisation.",
    ...
    // Contact
    "contact.title": "Travaillez avec moi",
    "contact.subtitle": "Construisons quelque chose d'exceptionnel",
    "contact.description":
      "Un projet en tête ? Parlez-moi de votre idée — je serais ravi de collaborer avec vous.",
    "contact.intro":
    ...
    "contact.ctaPrimary": "Démarrer un projet",
    "contact.ctaSecondary": "Voir les packs",
